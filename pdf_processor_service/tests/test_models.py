...
class TestTextChunkData:
    def test_valid_text_chunk_data(self):
        ...
        chunk = TextChunkData(
            chunk_id=1,
            page=5,
            chunk="This is a text chunk from the document."
        )
...
class TestImageResponse:
    def test_valid_image_response(self):
        ...
        images = [
            ImageData(image_key="doc123/image1.png", url="https://example.com/image1.png"),
            ImageData(image_key="doc123/image2.png", url="https://example.com/image2.png")
        ]
