...
class TestImageCaptioningResponse:
    def test_valid_image_captioning_response(self):
        ...
        assert response.caption == "A beautiful sunset over the ocean with waves crashing on the shore."
...
class TestVLMConfig:
    ...
    def test_vlm_config_default_values(self):
        ...
        with pytest.MonkeyPatch().context() as mp:
            ...
            for key in ["MODEL_TEMPERATURE", "MODEL_MAX_TOKENS", "MODEL_TOP_P", 
                       "MODEL_FREQ_PENALTY", "MODEL_PRESENCE_PENALTY", "ENABLE_RESPONSE_POST_PROCESSING"]:
