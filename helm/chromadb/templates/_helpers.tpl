...
helm.sh/chart: {{ include "chromadb.chart" . }}
...
*/}}
{{- define "chromadb.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "chromadb.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- else }}
{{- include "chromadb.fullname" . }}-data
{{- end }}
{{- end }}