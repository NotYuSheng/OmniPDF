...
class TestPdfRenderRouter:
    ...
    def test_pdf_render_http_error(self, mock_httpx_client):
        ...
        assert response.status_code == 422  # HTTPStatusError gets raised before our handler

    @patch('routers.render.run_in_threadpool')
    @patch('routers.render.httpx.AsyncClient')
    def test_pdf_render_processing_error(self, mock_httpx_client, mock_run_in_threadpool):
    ...
    @patch('routers.render.run_in_threadpool')
    @patch('routers.render.httpx.AsyncClient')
    def test_pdf_render_s3_client_error(self, mock_httpx_client, mock_run_in_threadpool):
