...
class TestSemanticRoutes:
    def test_semantic_embedding_success(self, client, sample_data_request):
        ...
        mock_embed_results = {"status": "success", "chunks_embedded": 1}

        with (
            patch("routers.semantic.data_chunking") as mock_chunk,
            ...
            response = client.post("/semantic/", json=sample_data_request.model_dump())
